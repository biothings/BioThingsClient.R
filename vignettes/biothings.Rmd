...
#### Example: `btGet`
These methods can be used with a defined `BioThings` class object or with just the name of a client from the `biothings_clients` object.
...
> btGet(biothings, "1017")
> btGet(biothings, c("1017","1018","ENSG00000148795"))
```
